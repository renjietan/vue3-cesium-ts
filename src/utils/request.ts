...
const ERR_TYPE: {[key: string]: string} = {
    400: "错误的请求",
    401: "未授权，请重新登录",
    403: "拒绝访问",
    404: "请求错误,未找到该资源",
 ...
 */
const request = (url: string, method: string, query: {[key: string]: any} = {}, config: {[key: string]: any} = {}) => {
    const isPost = METHODS.indexOf(method) > -1;
